...
Rationale: Initial ratification of the sharebox constitution. All principles and
sections authored from scratch based on project memo.md, DESIGN.md, and user input.
...
Templates requiring updates:
  ✅ .specify/templates/plan-template.md — "Constitution Check" section uses
     placeholder "[Gates determined based on constitution file]"; no edits needed
     as it resolves against this file at plan time.
  ✅ .specify/templates/spec-template.md — no principle-specific slots to update.
  ✅ .specify/templates/tasks-template.md — task categorization compatible with
     E2E + unit test discipline specified in Principle V.
...
| 認証 | Google OAuth を Arctic + Lucia で自前実装、ホワイトリスト 1 ユーザー |
